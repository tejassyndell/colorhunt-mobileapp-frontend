...
import slider3 from 'src/assets/Colorhuntimg/loginimg/sliderscreen/handsome-confident-hipster-modelsexy-unshaven-man-dressed-summer-stylish-green-hoodie-jeans-clothes-fashion-male-with-curly-hairstyle-posing-studio-isolated-blue 1.png'
                ...
                <div class="carousel-inner">
                    ...
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption1 d-none d-md-block">
                            ...
                            <p className='bestpack' style={{ color: 'rgba(255, 255, 255, 1)' }}>SMART  <br />
                                FORMALS</p>
                            <p className='discounts3' style={{ color: 'rgba(255, 255, 255, 1)' }}>MIN <br />
                                30% OFF*</p>
                            <button className='sliderbutton2' onClick={changedashboard} style={{ color: 'rgba(0, 0, 0, 1)', backgroundColor: 'rgba(255, 255, 255, 1)' }}>SHOP</button>
                        </div>
                    </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            ...
                            <p className='discounts3'>FLAT <br />
                                50% OFF*</p>
                            <button className='sliderbutton2' onClick={changedashboard}>SHOP</button>
                        </div>
                    </div>
